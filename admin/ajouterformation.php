        ...
        <div id="layout-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Ajouter formation </h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Ajouter formation</h4>
                                        
                                        

		
                                        <form action="Controller/ajouter_formation.php" method="post">
            ...
            <div class="form-group">
              <figure>
                ...
                <img  class="form-control"   id="duree" name="duree"  
                placeholder="" > 
              </figure>       
            </div>
