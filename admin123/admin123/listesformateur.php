...
$req = $bdd->query("SELECT * FROM formateur ");
//$donnees = $req->fetch();
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Listes formateur</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Proforma</a></li>
                                            <li class="breadcrumb-item active">Listes formateur</li>
                                        </ol>
                                    </div>
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        ...
        <a href="modifierformateur.php?id=<?php echo $donnees['id']; ?>">Modifier</a>||
