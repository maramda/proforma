                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p>Connectez-vous pour continuer sur ProForma.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0"> 
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" action="Controller/cnx_client.php" method="post">
        
                                    <div class="form-group">
                                            <label for="login">Nom d'utilisateur</label>
                                            <input type="text" class="form-control" id="login"  name="login" placeholder="Saisissez votre nom d'utilisateur">
                                        </div>
                
                                        <div class="form-group">
                                            <label for="password">Mot de passe</label>
                                            <input type="password" class="form-control" id="oassword" name="password"  placeholder="Saisissez votre Mot de passe">        
                                        </div>
