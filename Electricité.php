...
<head>
    ...
    <h3> <b> <center> Eléctricité</center>  </b> </h3><br><br>
            ...
            <?php while($donnees4 = $req4->fetch()){ ?>
			    <div class="col-md-3 col-sm-6">
					...
					<div class="latest-b-image">
                         <img src="<?php echo $donnees4['img']; ?>" class="img-responsive" alt="services-image">  </div>
                        <td> <p><?php echo $donnees4['code']; ?></p></td>
                        <td><h4><?php echo $donnees4['titre']; ?></h4></td>
                        <td><p><?php echo $donnees4['duree']; ?></p></td>
                    </div>
                </div>
